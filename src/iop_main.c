...
int main(int argc, char** argv){
  ...
  iannounce("iop_debug_flag = %d\n", iop_debug_flag);
  iannounce("iop_no_windows_flag = %d\n", iop_no_windows_flag);
  iannounce("iop_hardwired_actors_flag = %d\n", iop_hardwired_actors_flag);
  iannounce("iop_remote_fd       = %d\n", iop_remote_fd);
  iannounce("iop_server_mode     = %d\n", iop_server_mode);
  iannounce("iop_port            = %s\n", iop_port);
